                                ...
                                <?php foreach ($medical_history['family_history'] as $idx => $fh): ?>
                                    <tr>
                                        ...
                                        <td style="text-align:center; vertical-align:middle;">
                                            <button type="button" class="edit-btn"
                                                style="background:#f1c40f;color:#fff;border:none;padding:0.3em 0.8em;margin:auto;border-radius:5px;cursor:pointer;font-weight:600;font-size:0.95em;"
                                                onclick="openEditFamilyHistModal('editFamilyHistModal<?= $idx ?>', <?= htmlspecialchars(json_encode($fh), ENT_QUOTES, 'UTF-8') ?>)">Edit</button>
                                        </td>
                                    </tr>
                                ...
                                <?php foreach ($medical_history['surgical_history'] as $idx => $surg): ?>
                                    <tr>
                                        ...
                                        <td style="text-align:center; vertical-align:middle;">
                                            <button type="button" class="edit-btn"
                                                style="background:#f1c40f;color:#fff;border:none;padding:0.3em 0.8em;margin:auto;border-radius:5px;cursor:pointer;font-weight:600;font-size:0.95em;"
                                                onclick="openEditSurgHistModal('editSurgHistModal<?= $idx ?>', <?= htmlspecialchars(json_encode($surg), ENT_QUOTES, 'UTF-8') ?>)">Edit</button>
                                        </td>
                                    </tr>
                                    ...
                                    <div id="editSurgHistModal<?= $idx ?>" class="custom-modal" style="display:none;">
                                        <div class="custom-modal-content" style="max-width:400px;">
                                            ...
                                            <form method="post" action="update_medical_history.php">
                                                ...
                                                <input type="hidden" name="patient_id" value="<?= $patient_id ?>">
                                                <input type="text" name="surgery" value="<?= h($surg['surgery']) ?>" required
                                                    style="width:100%;">
                                                </label><br>
                                                <label>Surgery*
                                                ...
                                                <input type="text" name="hospital" value="<?= h($surg['hospital']) ?>" required
                                                    style="width:100%;">
                                                </label><br>
                                                <label>Hospital*
                                                    <select name="hospital_dropdown" id="edit-hospital-select-<?= $idx ?>"
                                                        ...
                                                        <option value="South Cotabato Provincial Hospital">South Cotabato
                                                            Provincial Hospital</option>
                                                        <option value="Dr. Arturo P. Pingoy Medical Center (DAPPMC)">Dr. Arturo
                                                            P. Pingoy Medical Center (DAPPMC)</option>
                                                        <option value="Allah Valley Medical Specialists' Center, Inc. (AVMSCI)">
                                                            Allah Valley Medical Specialists' Center, Inc. (AVMSCI)</option>
                                                        <option value="Socomedics Medical Center">Socomedics Medical Center
                                                        </option>
                                                        <option value="Others">Others (specify)</option>
                                                    </select>
                                    ...
                                    <script>
                                        function openEditSurgHistModal(modalId, surg) {
                                            ...
                                            // No dropdowns for surgery/hospital in this version, just fill values if needed
                                        }
                                    </script>
                                <?php endforeach; ?>
                            <?php else: ?>
                                ...
                                <?php foreach ($medical_history['current_medications'] as $idx => $med): ?>
                                    <tr>
                                        ...
                                        <td style="text-align:center; vertical-align:middle;">
                                            <button type="button" class="edit-btn"
                                                style="background:#f1c40f;color:#fff;border:none;padding:0.3em 0.8em;margin:auto;border-radius:5px;cursor:pointer;font-weight:600;font-size:0.95em;"
                                                onclick="openEditMedModal('editMedModal<?= $idx ?>', <?= htmlspecialchars(json_encode($med), ENT_QUOTES, 'UTF-8') ?>)">Edit</button>
                                        </td>
                                    </tr>
                                ...
                                <?php foreach ($medical_history['immunizations'] as $idx => $imm): ?>
                                    <tr>
                                        ...
                                        <td style="text-align:center; vertical-align:middle;">
                                            <button type="button" class="edit-btn"
                                                style="background:#f1c40f;color:#fff;border:none;padding:0.3em 0.8em;margin:auto;border-radius:5px;cursor:pointer;font-weight:600;font-size:0.95em;"
                                                onclick="openEditImmunModal('editImmunModal<?= $idx ?>', <?= htmlspecialchars(json_encode($imm), ENT_QUOTES, 'UTF-8') ?>)">Edit</button>
                                        </td>
                                    </tr>
