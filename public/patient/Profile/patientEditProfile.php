...
<body>
    <header class="topbar">
        ...
        <div class="topbar-userinfo">
            ...
            <img src="PhotoController.php?patient_id=<?= urlencode($patient_id) ?>" alt="User Profile" class="topbar-userphoto"
        ...
        <div class="profile-wrapper">
            ...
            <div class="profile-photo-col">
                <form class="profile-card profile-photo-form" id="profilePhotoForm" method="post"
                    ...
                    <div class="profile-photo-container">
                        <img src="PhotoController.php?patient_id=<?= urlencode($patient_id) ?>" alt="Profile Photo" id="profilePhotoPreview"
            ...
            <div class="profile-info-col">
                ...
                <form class="profile-card" id="personalInfoForm" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        <label>Last Name <input type="text" name="last_name" value="<?= h($patient['last_name']) ?>"
                                required readonly class="uneditable-field"></label>
                        <label>First Name <input type="text" name="first_name" value="<?= h($patient['first_name']) ?>"
                                required readonly class="uneditable-field"></label>
