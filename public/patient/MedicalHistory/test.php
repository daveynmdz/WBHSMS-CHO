...
<head>
    ...
    <script src="medicalHistory.js"></script>
    <style>
        .profile-wrapper {
            max-width: 1500px;
...
<body>
    <header class="topbar">
        ...
        <div class="topbar-userinfo">
            ...
            <img src="../PhotoController.php?patient_id=<?= urlencode($patient_id) ?>" alt="User Profile"
                ...
                <div class="profile-row three-cols">
                    ...
                    <div class="profile-photo-col">
                        <div class="profile-card">
                                        ...
                                        <?php foreach ($medical_history['allergies'] as $idx => $allergy): ?>
                                            ...
                                            <script>
                                                ...
                                                function openCustomDeletePopup(table, id, btn) {
                                                    ...
                                                    document.querySelectorAll('.custom-delete-popup').forEach(function(popup) {
                            ...
                            <!-- Add Allergy Form -->
                            <form method="post" action="../../../src/MedicalHistory/add_medical_history.php" class="neat-add-form"> <input type="hidden" name="table" value="allergies">
                                <h4>Add New Allergy</h4>
                                <div class="form-group">
                                    <label for="add-allergen-select">Allergen*</label>
                                    <select name="allergen_dropdown" id="add-allergen-select" required onchange="editToggleOtherInput(this, 'add-allergen-other-input')">
                                        <option value="">Select Allergen</option>
                                        <option value="Peanuts">Peanuts</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="reaction_dropdown" id="add-reaction-select" required onchange="editToggleOtherInput(this, 'add-reaction-other-input')">
                                        <option value="">Select Reaction</option>
                                        <option value="Rash">Rash</option>
                                        <option value="Anaphylaxis">Anaphylaxis</option>
                                        <option value="Itching">Itching</option>
    ...
    <script>
        ...
        modalCancel.addEventListener('click', function() {
            window.location.href = '../patientProfile.php'; // Correct path for going back to profile
        });
