/**
 * medicalHistory.js
 * Utility scripts for PatientEditMedHistory.php
 * ------------------------------------------------
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    window.proceedDelete = function (table, id, btn) {
        btn.disabled = true;
        fetch('../../../src/MedicalHistory/delete_medical_history.php', {
            method: 'POST',
    ...
    if (addAllergyForm) {
        addAllergyForm.addEventListener('submit', function (e) {
            ...
            fetch('../../../src/MedicalHistory/add_medical_history.php', {
                method: 'POST',
                headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
    ...
    document.querySelectorAll('.editAllergyForm').forEach(function (form) {
        form.addEventListener('submit', function (e) {
            ...
            const params = new URLSearchParams();
            for (const pair of formData) { params.append(pair[0], pair[1]); }
            fetch('../../../src/MedicalHistory/update_medical_history.php', {
                method: 'POST',
                headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
                body: params.toString()
            })
